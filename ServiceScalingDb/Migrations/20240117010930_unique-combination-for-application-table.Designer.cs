...
namespace ServiceScalingDb.Migrations
{
    ...
    [Migration("20240117010930_unique-combination-for-application-table")]
    partial class uniquecombinationforapplicationtable
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ServiceScalingDb.ScalingDb.Application", b =>
                {
                    ...
                    b.HasIndex("ApplicationName", "ProjectID")
                        .IsUnique();
